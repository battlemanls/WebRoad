...
@section('content')
    <div class="wrap_content">
        ...
        <div class="search_block">
            <form class="search_form" name="search_form" method="post" action={{route('admin_panel.stan_dorig.catalog.search')}}>
                @csrf
                <div>
            ...
            @foreach($data as $d)
                <div class="wrap_page_nth">
                    ...
                    <div class="control_page">
                        <a href="{{url($d->url)}}"><button class="save"><span>Відкрити</span></button></a>
                        <a href="{{route('admin_panel.stan_dorig.edit',[$d->id])}}"><button class="edit"><span>Редагувати</span></button></a>
                        <form method = 'post' action="{{ route('admin_panel.stan_dorig.delete', $d->id ) }}" >
                            @csrf
                            {{method_field('DELETE')}}
